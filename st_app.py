...
def main():
    ...
    st.sidebar.info(
        ...
        "This app was recently rebooted as it surpassed streamlit share's resource limits. My deepest apologies to any users who lost their data, there will be a global fix available soon.  \n"
