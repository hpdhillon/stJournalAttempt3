...
def main():
    ...
    st.sidebar.info(
        ...
        "Reporting mistakes greatly helps me predict better in the future. I do not have access to any user data, so if you'd like to help me, please fill out the google form linked on the resources page with your journal entry and what you feel the model should have output. Thank you!  \n"
