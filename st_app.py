...
def main():
    ...
    st.sidebar.info(
        ...
        "/nThank you to Kevin Northover for introducing me to streamlit, last year at a New Jersey Data Science Meetup"
        "/nThank you to UKPLab for creating sentence-bert, Stanford for the open pessimist/optimist tweet data, the isear dataset curators and google's colab creators for giving us the platform we needed to generate our complex features and model"
    )
